...
The repository follows sequential MVP gates. Module M0 provides the verified
engineering foundation; identity and business modules remain disabled until
their own acceptance gates pass.

| Module | Status |
| --- | --- |
| M0 · Engineering foundation | Implemented |
| M1 · Identity and access | Not started |
| M2–M10 | Not started |
...
```bash
cd server
TEST_DATABASE_URL='postgres://...' go test -tags=integration ./internal/database
```
